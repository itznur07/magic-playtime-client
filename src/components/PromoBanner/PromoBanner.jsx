...
import promoImage from "../../assets/OurService2.webp";
import promoImage1 from "../../assets/landscape-img-crd5.webp";
    ...
    <div className='grid md:grid-cols-9 col-span-12 gap-5 mt-10 md:mx-0 mx-5'>
      <div className='relative md:col-span-3 col-span-1 order-last'>
        <img
          src={
            promoImage ||
            "https://img.freepik.com/free-photo/cute-fluffy-monkey-toys_23-2149642406.jpg?w=360&t=st=1688696133~exp=1688696733~hmac=338fe24fe73d8d51ac4fbec7a9163d9cab755ff05d647602466f03c185f764b1"
          }
          alt='Bunny and dog'
      ...
      <div className='relative md:col-span-6 col-span-1 overflow-hidden rounded-lg'>
        <img
          src={
            promoImage1 ||
            "https://img.freepik.com/free-photo/cute-plush-toys-arrangement_23-2150312306.jpg?w=1060&t=st=1688707306~exp=1688707906~hmac=bf402252821b7b148d052aed51c4e6aecead61f554dc9c43494ccccc44ad96fb"
          }
          alt='Price tag'
